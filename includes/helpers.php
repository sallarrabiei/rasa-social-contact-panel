...
class RASASCP_Helpers {
	...
	public static function get_value_placeholder( $platform_id ) {
		$placeholders = [
			'whatsapp'  => __( 'Phone number with country code, e.g. +1234567890', 'rasa-social-contact-panel' ),
			'telegram'  => __( 'Username (e.g. @yourname) or phone number', 'rasa-social-contact-panel' ),
			'messenger' => __( 'Facebook username or page name', 'rasa-social-contact-panel' ),
			'instagram' => __( 'Instagram username, e.g. @yourname', 'rasa-social-contact-panel' ),
			'facebook'  => __( 'Facebook page URL or username', 'rasa-social-contact-panel' ),
			'twitter'   => __( 'X/Twitter username, e.g. @yourname', 'rasa-social-contact-panel' ),
			'linkedin'  => __( 'LinkedIn profile URL or username', 'rasa-social-contact-panel' ),
			'tiktok'    => __( 'TikTok username, e.g. @yourname', 'rasa-social-contact-panel' ),
			'youtube'   => __( 'YouTube channel URL or handle', 'rasa-social-contact-panel' ),
			'snapchat'  => __( 'Snapchat username', 'rasa-social-contact-panel' ),
			'pinterest' => __( 'Pinterest username', 'rasa-social-contact-panel' ),
			'discord'   => __( 'Discord invite code or link', 'rasa-social-contact-panel' ),
			'skype'     => __( 'Skype username or ID', 'rasa-social-contact-panel' ),
			'viber'     => __( 'Phone number with country code, e.g. +1234567890', 'rasa-social-contact-panel' ),
			'line'      => __( 'Line username', 'rasa-social-contact-panel' ),
			'wechat'    => __( 'WeChat page URL', 'rasa-social-contact-panel' ),
			'email'     => __( 'Email address', 'rasa-social-contact-panel' ),
			'phone'     => __( 'Phone number with country code, e.g. +1234567890', 'rasa-social-contact-panel' ),
			'sms'       => __( 'Phone number with country code, e.g. +1234567890', 'rasa-social-contact-panel' ),
			'website'   => __( 'Full URL including https://', 'rasa-social-contact-panel' ),
		];

		return $placeholders[ $platform_id ] ?? __( 'Enter value', 'rasa-social-contact-panel' );
	}
}
