...
Smart Social Contact Panel adds a floating contact button to your WordPress site. Visitors click the button to open a clean popup panel with your selected social and contact platforms.
...
1. Upload the `smart-social-contact-panel` folder to the `/wp-content/plugins/` directory, or install the plugin through the WordPress Plugins screen.
